...
function wda_customize_theme_posts($wp_customize) {
   ...
   $wp_customize->add_control(
      ...
      array('type' => 'checkbox',
            ...
            'description' => esc_html__( 'Posts pages have a sidebar (may require refresh). You can place functional widgets in the Post Sidebar under Appearance - Widgets.','wda' ))
   );
